...
description: >
  ATLAS proof-film system adapted from Broadside. The unit is the frame (1920×1080). Its atoms are
  the two-register surface system (near-black / ATLAS mint), massive Space Grotesk in lowercase weight
  700 treated as a graphic primitive, JetBrains Mono chrome (uppercase, 0.14em), one mint accent, flat planes
  and 1px hairline dividers. Composition and frame scale are rewritten for the product demo.
unit: the frame — 1920×1080 primary; 9:16 and 1:1 documented
principle: atoms are sacred · composition is free · numbers come from the script

colors:
  ink-black: "#0B0E0F"
  ink-black-alt: "#111516"
  fire-orange: "#63E6A6"
  cream: "#F0F3F1"
  cream-muted: "#A7B0AD"
  cream-hint: "#727C79"
...
- **Fonts** — already set to **Space Grotesk** (display/body) / **JetBrains Mono** (chrome); ignore any preset font name lingering in prose.
- **Colors** — use the frontmatter hex. The inherited `fire-orange` token name means ATLAS mint `#63E6A6`, not orange.
...
and size, not face contrast. **SFMono-Regular** is chrome only (numbers, kickers, tags, axis labels,
