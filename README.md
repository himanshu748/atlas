...
| Public judge boundary | Labelled fixtures, deterministic inference, read-only routes and a zero-role runtime identity |
| Runtime | `cloud` |
...
| Public judge console | Separate Cloud Run service `atlas-public-demo`; fixture-only GET allowlist with no model, cloud-data, upload, stream or mutation access |
